                ...
                <div class="container col-sm-6">
                    <form method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" reandoly value="<?php echo $DatosEstudiantesUser->documento; ?>" name="txtDoc" class="form-control" id="inputIdenc">
                        </div>
                        <br>
                        <div class="form-group">
                                    <label for="inputNombreE"><strong>Nombre del Estudiante</strong></label>
                                    <input type="text" value="<?php echo $DatosEstudiantesUser->nombreEstudiante; ?>" name="txtNombreE" class="form-control" id="inputNombreE" placeholder="Ingrese Nombre del Estudiante" required>
                                </div>
                                <br>
                                <div class="form-group">
