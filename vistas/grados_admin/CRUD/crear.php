    ...
    <div class="row d-flex flex-grid justify-content-center">
        <div class="col-md-8">
            <div class="card card-color">
                <div class="card-header text-white bg-warning text-center"><strong>Creación de Estudiantes Nuevos</strong></div>
                <div class="card-body">
                    <div class="container col-sm-6">
                        <form method="POST" action="index.php?controlador=estudiantesAdmin&accion=crearEstudianteAdmin">
                            <div class="form-group">
                                <label for="inputN°"><strong>N°</strong></label>
                                <input type="text" name="txtN°" class="form-control" id="inputN°" placeholder="Ingrese el Número" required>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="inputDocumento"><strong>Documento de Identidad</strong></label>
                                <input type="text" name="txtdocumento" class="form-control" id="inputDocumento" placeholder="Ingrese Documento de Identidad" required>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="inputNombreE"><strong>Nombre del Estudiante</strong></label>
                                <input type="text" name="txtnombreE" class="form-control" id="inputNombreE" placeholder="Ingrese Nombre del Estudiante" required>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <br>
                            <center><button type="submit" class="btn text-white btn-warning">Crear Estudiante</button></center>
                        </form>
                    </div>
                </div>
            </div>
